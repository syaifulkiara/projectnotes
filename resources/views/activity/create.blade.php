...
<div class="col-sm-12">
    <div class="white-box">
        ...
        <h3 class="box-title m-b-0">Input Data Overtime</h3>
        <div class="row">
            <div class="col-sm-12 col-xs-12">
                <form action="{{route('activity.store')}}" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="day_date">Name</label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="input_start" name="start"  data-inputmask="'mask': '99:99'"> 
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="input_finish" name="finish" data-inputmask="'mask': '99:99'"> 
                            </div> 
                        </div>
                    </div>
                    <div class="form-group">
